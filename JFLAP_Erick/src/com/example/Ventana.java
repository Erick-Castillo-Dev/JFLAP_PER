...
public class Ventana extends JFrame implements ActionListener {
	...
	private JMenuItem ar_nuevo, ar_abrir, ar_guardar, ar_imagen, ar_imprimir,
			ar_salir;
	...
	public Ventana() {
		 ...
		 * this.setLayout(null); this.setSize(500, 500);
		 ...
		 * Dimension ventana = this.getSize(); this.setLocation(((pantalla.width
		 * - ventana.width) / 2), ((pantalla.height - ventana.height) / 2));
		 */
